...
public class Sled2{
	...
	public Sled2() {
		forward 	= getImage("/imgs/"+"Opposite Sleigh.png"); //load the image for Tree
		backward 	= getImage("/imgs/"+"Opposite Sleigh.png"); //load the image for Tree
		left 		= getImage("/imgs/"+"Opposite Sleigh.png"); //load the image for Tree
		right 		= getImage("/imgs/"+"Opposite Sleigh.png"); //load the image for Tree

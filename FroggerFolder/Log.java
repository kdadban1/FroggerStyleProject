...
public class Log{
	...
	double scaleWidth = 0.17;		//change to scale image
	double scaleHeight = 0.17; 		//change to scale image

	public Log() {
		forward 	= getImage("/imgs/"+"log.png"); //load the image for Tree
		backward 	= getImage("/imgs/"+"log.png"); //load the image for Tree
		left 		= getImage("/imgs/"+"log.png"); //load the image for Tree
		right 		= getImage("/imgs/"+"log.png"); //load the image for Tree

...
public class Present{
	...
	public Present() {
		forward 	= getImage("/imgs/"+"finalpresent.png"); //load the image for Tree
		backward 	= getImage("/imgs/"+"finalpresent.png"); //load the image for Tree
		left 		= getImage("/imgs/"+"finalpresent.png"); //load the image for Tree
		right 		= getImage("/imgs/"+"finalpresent.png"); //load the image for Tree
	...
	Rectangle thisObject = new Rectangle(getX(),getY(),getWidth(),getHeight());
